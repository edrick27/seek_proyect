...
class QrScannerApi {
  ...
  Future<QrScanResult> scanQrCode() async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.seek_project.QrScannerApi.scanQrCode$pigeonVar_messageChannelSuffix';
  ...
  Future<bool> isQrScanAvailable() async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.seek_project.QrScannerApi.isQrScanAvailable$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
